...
from services.career_service import (
    ...
    get_jobs_paged,
    get_tech_trends_by_category  # ✅ 이 함수가 있어야 차트 분리가 가능합니다!
)
...
def serialize_job(job):
    ...
    unique_tags = list(set(raw_tags)) # 중복 제거
...
def career_dashboard(
    ...
    return {
        "mode": mode,
        "jobs": jobs,
        "frontend_trends": frontend_trends, # 프론트 차트용
        "backend_trends": backend_trends,   # 백엔드 차트용
